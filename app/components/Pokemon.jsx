...
function Pokemon() {
    ...
    return (
        ...
        // Style them up
        <div className=' md:flex block items-center justify-between w-3/5 ml-auto mr-auto poke-container h-4/5 bg-gray-900 bg-opacity-50 absolute transform top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:p-10 p-5 pl-10 pr-10 rounded-lg ring-1 ring-gray-700'>
